...
export function NewsGrid() {
  ...
  const allNews = [
    ...
    },
    {
      ...
      title: 'Penerimaan Rapor Semester Ganjil TA 2026/2027',
      desc: 'Jadwal pengambilan rapor akan dilaksanakan secara bertahap mulai hari Senin depan. Wali murid diwajibkan hadir sesuai dengan sesi yang telah ditentukan oleh sekolah.',
    ...
    },
    {
      ...
      title: 'Tim Moklet Dev Raih Best Innovation Telkom Hackathon',
      desc: 'Aplikasi pemantau kualitas udara berbasis IoT buatan tim Moklet Dev berhasil mengalahkan lebih dari 50 peserta dari seluruh SMK di Indonesia.',
    ...
    },
    {
      ...
      title: '100% Lulusan Tahun Ini Terserap di Dunia Industri',
      desc: 'Pencapaian luar biasa ini diraih berkat dukungan program Link and Match dengan lebih dari 500 perusahaan mitra industri di seluruh Indonesia.',
      ...
      {filteredNews.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {filteredNews.map((news) => (
            <Link key={news.id} href="#" className="bg-white rounded-2xl overflow-hidden border border-border-light shadow-sm hover:-translate-y-1 hover:shadow-lg transition-all duration-300 group flex flex-col h-full">
