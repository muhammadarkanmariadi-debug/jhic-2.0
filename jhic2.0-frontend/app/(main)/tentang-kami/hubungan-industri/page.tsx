            ...
            <div className="flex flex-col lg:flex-row gap-10">
               <aside className="w-full lg:w-64 flex-shrink-0 space-y-8">
                  <div>
                     ...
                     <input type="text" placeholder="Nama mitra..." className="w-full px-4 py-3 rounded-xl border border-border-color focus:outline-none focus:ring-2 focus:ring-accent/50 bg-surface-alt" />
                  </div>
                  <div>
                     ...
                     <div className="space-y-3">
                        {['Network & Infrastructure', 'Software House', 'Hosting & Cloud', 'Creative & Design'].map(cat => (
                           <label key={cat} className="flex items-center gap-3 cursor-pointer group">
                              <input type="checkbox" className="w-5 h-5 rounded border-border-color text-accent focus:ring-accent accent-accent" />
