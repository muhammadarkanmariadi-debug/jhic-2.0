...
export default function CCPPage() {
  ...
  return (
    <main>
         ...
         <div className="container max-w-[1200px] mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
               {features.map((feature, index) => (
                  <Card key={index} className="p-8 hover:-translate-y-2 transition-transform cursor-default bg-white flex flex-col md:flex-row items-start gap-6">
                     <div className="shrink-0 w-16 h-16 rounded-2xl bg-text-main text-white flex items-center justify-center">
                        {feature.icon}
                     </div>
                     <div>
      ...
      <section className="py-16 md:py-24 bg-text-main text-white relative overflow-hidden">
