...
export function PPDBPrestasi() {
  return (
    <div className="bg-surface rounded-xl overflow-hidden border border-border-light shadow-sm flex flex-col lg:flex-row">
      ...
      <div className="flex-1 p-10 md:p-14 lg:p-16 flex flex-col justify-center">
        ...
        <Link 
          ...
          target="_blank"
          className="bg-accent hover:bg-accent-hover text-text-inverse font-bold px-8 py-4 rounded-xl transition-all w-fit shadow-md hover:shadow-lg inline-flex"
        >
      ...
      <div className="w-full lg:w-[45%] bg-surface-alt p-10 md:p-14 flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-border-light relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-surface/40 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
        ...
        <ul className="space-y-5">
          <li className="flex gap-4">
            <div className="w-6 h-6 rounded-full bg-surface border border-border-light flex items-center justify-center shrink-0 mt-0.5 text-accent font-bold text-xs shadow-sm">1</div>
            <p className="text-text-muted leading-relaxed">Siswa kelas 9 SMP/MTs sederajat tahun ajaran berjalan.</p>
          </li>
          <li className="flex gap-4">
            <div className="w-6 h-6 rounded-full bg-surface border border-border-light flex items-center justify-center shrink-0 mt-0.5 text-accent font-bold text-xs shadow-sm">2</div>
            <p className="text-text-muted leading-relaxed">Memiliki NISN yang terdaftar di sistem kementerian.</p>
          </li>
          <li className="flex gap-4">
            <div className="w-6 h-6 rounded-full bg-surface border border-border-light flex items-center justify-center shrink-0 mt-0.5 text-accent font-bold text-xs shadow-sm">3</div>
          ...
          <li className="flex gap-4">
            <div className="w-6 h-6 rounded-full bg-surface border border-border-light flex items-center justify-center shrink-0 mt-0.5 text-accent font-bold text-xs shadow-sm">4</div>
