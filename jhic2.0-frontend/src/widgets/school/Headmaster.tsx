...
export function Headmaster() {
  return (
    <section id="about-head" className="bg-surface py-20 md:py-32">
      <div className="mx-auto w-full max-w-[1400px] px-4 md:px-8">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
          <div className="relative w-full max-w-[400px] lg:w-1/2">
            ...
            <div className="relative overflow-hidden rounded-[32px] border border-border-color bg-surface">
              <Image
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="relative">
              ...
              <p className="relative z-10 text-[18px] leading-[1.8] text-neutral-700 md:text-[22px]">
            ...
            <div className="mt-10 flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-accent text-[16px] font-extrabold text-text-inverse">
                RD
              </div>
              <div>
