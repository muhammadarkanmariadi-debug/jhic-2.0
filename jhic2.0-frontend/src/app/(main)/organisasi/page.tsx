  ...
  return (
    <main>
        ...
        <div className="container max-w-[900px] mx-auto px-4 md:px-6">
          ...
          <div className="space-y-5">
            {organizations.map((org) => (
              <div
                key={org.id}
                className="flex items-start gap-5 rounded-2xl border border-border-light bg-white p-6 shadow-sm hover:shadow-md hover:border-accent/30 transition-all"
              >
      ...
      <section className="pb-16 md:pb-24 bg-white">
        <div className="container max-w-[900px] mx-auto px-4 md:px-6">
          <div className="bg-gradient-to-r from-accent to-red-700 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden shadow-2xl flex flex-col md:flex-row items-center justify-between gap-10">
