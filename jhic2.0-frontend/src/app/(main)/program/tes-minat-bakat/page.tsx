    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="py-12 md:py-20">
        <div className="container max-w-[800px] mx-auto px-4">
          ...
          {!showResult ? (
            <div className="bg-surface rounded-xl shadow-sm border border-border-light p-6 md:p-10 animate-in fade-in slide-in-from-bottom-4">
              {/* Progress Bar */}
              <div className="mb-10">
              ...
              <div className="space-y-4">
                {quizQuestions[currentQuestion].options.map((option, idx) => (
                  <button
                    ...
                    className="w-full text-left p-5 rounded-lg border-2 border-border-light hover:border-accent hover:bg-accent/5 transition-all focus:outline-none focus:ring-4 focus:ring-accent/20 flex items-center justify-between group"
                  >
                    <span className="text-lg text-neutral-700 font-medium">{option.text}</span>
                    <div className="w-8 h-8 rounded-full border-2 border-neutral-200 flex items-center justify-center shrink-0 group-hover:border-accent group-hover:bg-accent group-hover:text-text-inverse transition-colors">
            ...
            <div className="bg-surface rounded-xl shadow-sm border border-border-light overflow-hidden animate-in fade-in zoom-in-95 duration-500">
              <div className={`${recommendedJurusan.color} p-10 md:p-16 text-center text-text-inverse relative`}>
                <div className="absolute inset-0 bg-black/10 mix-blend-overlay"></div>
                <div className="relative z-10 flex flex-col items-center">
                  <div className="w-24 h-24 bg-surface/20 rounded-xl backdrop-blur-md flex items-center justify-center mb-6">
                    <recommendedJurusan.icon className="w-12 h-12 text-text-inverse drop-shadow-md" />
                  </div>
                  <div className="inline-block px-4 py-1.5 rounded-full bg-surface/20 backdrop-blur-md text-sm font-bold tracking-wider mb-4">
                    REKOMENDASI UTAMA KAMU
                  </div>
                  <h2 className="text-3xl md:text-5xl font-extrabold mb-4 drop-shadow-md">
                    {recommendedJurusan.title}
                  </h2>
                  <p className="text-lg md:text-xl font-medium max-w-2xl text-text-inverse/90 leading-relaxed">
              ...
              <div className="p-6 md:p-10">
                ...
                <div className="space-y-6 mb-10">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-bold text-neutral-700">RPL (Software Engineering)</span>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-bold text-neutral-700">TKJ (Computer & Network)</span>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <span className="font-bold text-neutral-700">PG (Game Development)</span>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                  <Link 
                    ...
                    className="w-full sm:w-auto flex-1 flex items-center justify-center gap-2 bg-accent text-text-inverse py-3.5 px-6 rounded-xl font-bold hover:bg-accent-hover transition-colors shadow-[0_8px_20px_rgba(215,25,32,0.26)] hover:shadow-accent"
                  >
                  ...
                  <button 
                    onClick={resetQuiz}
                    className="w-full sm:w-auto flex items-center justify-center gap-2 bg-neutral-100 text-text-main py-3.5 px-6 rounded-xl font-bold hover:bg-neutral-200 transition-colors"
                  >
