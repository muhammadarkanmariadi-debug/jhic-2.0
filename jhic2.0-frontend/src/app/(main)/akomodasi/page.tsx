...
import { LivingCostCalculator } from "@/widgets/akomodasi/LivingCostCalculator";
      ...
      <section className="py-16 md:py-24 bg-bg-main">
        <div className="container max-w-[1000px] mx-auto px-4 md:px-6">
          <SectionHeader
            ...
            title="Kalkulator Biaya Hidup"
            description="Sesuaikan pilihan tempat tinggal, makan, dan transportasi untuk memperkirakan biaya hidup bulananmu."
            align="center"
            className="mb-12"
          />
